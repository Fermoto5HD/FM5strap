/*
   ...
   Bootstrap está licenciado bajo MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)   FM5strap esta liceniado bajo CC-BY-4.0 (https://github.com/Fermoto5HD/FM5strap/LICENSE)*/
...
+function ($) {
  ...
  if ((version[0] < 2 && version[1] < 9) || (version[0] == 1 && version[1] == 9 && version[2] < 1) || (version[0] >= 3)) {
    throw new Error('El JavaScript de FM5strap necesita como mínimo jQuery v1.9.1 pero menor a la v3.0.0.')
  }
}(jQuery);
    ...
    _createClass(Modal, [{
      ...
      value: function _jQueryInterface(config, relatedTarget) {
        return this.each(function () {
          ...
          if (typeof config === 'string') {
            if (data[config] === undefined) {
              throw new Error('No hay método llamado "' + config + '"');
            }
...
var Tooltip = (function ($) {
  ...
  if (window.Tether === undefined) {
    throw new Error('Los tooltips de FM5strap requieren el framework Tether (http://github.hubspot.com/tether/)');
  }
