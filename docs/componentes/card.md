...
Un **card** es un contenedor flexible y extendible. Tiene opciones para agregar un encabezado como un pié, una gran variedad de contenido, colores contextuales para el fondo, y opciones de visualización potentes.

Si usaste Bootstrap 3, los cards son los panels, wells, y thumbnails. Similar functionality to those components is available as modifier classes for cards.
